...
class LabelledMap:
    ...
    def derivedMap(self):
        ...
        return LabelledMap(derivedSigma, derivedAlpha,
                           trust=True).canonicalRepresentant()
    ...
    def edgeMap(self):
        ...
        return LabelledMap(sigmaEdgeMap, alphaEdgeMap,
                           trust=True, ).canonicalRepresentant()
    ...
    def schaefferTree(self, markedDemiEdge):
        ...
        tauCanonical = tree.getRootedMapcorrespondence(
    ...
    def inverseShaefferTree(self, labelled, returnMarkedDemiEdge=True):
        ...
        if returnMarkedDemiEdge is True:
            ...
            canonicalTauA = quadA.getRootedMapcorrespondence(
                otherMap=quadACanonical, rootDemiEdge=root, return_map_perm=True, trust=True)
            canonicalTauB = quadB.getRootedMapcorrespondence(

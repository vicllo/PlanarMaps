...
class PlanarMap:
	...
	def buildGraph(self):
		...
		corres = [0] * int(2 * self.n + 1)			# associe à une demi-arête le sommet correspondant
		...
		for i in range(1, 2*self.n+1):			# pour chaque demi-arête, on ajoute une arête entre corres[i] et corres[alpha(i)]

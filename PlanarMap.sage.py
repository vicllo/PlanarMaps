...
_sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_1e10 = RealNumber('1e10'); _sage_const_0p2 = RealNumber('0.2'); _sage_const_1p2 = RealNumber('1.2'); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4); _sage_const_6 = Integer(6)
from sage.all_cmdline import *   # import sage library
import warnings
...
class PlanarMap:
	...
	def show(self):
		...
		if use_default:
			...
			gg = g.igraph_graph()
			layout = gg.layout_davidson_harel(seed = layout_seed, weight_edge_crossings = _sage_const_1e10 )
			layout.fit_into((_sage_const_0 ,_sage_const_0 ,_sage_const_1 ,_sage_const_1 ))
			
			fig, ax = plt.subplots()
			ax.set_xlim(-_sage_const_0p2 ,_sage_const_1p2 )
			ax.set_ylim(-_sage_const_0p2 ,_sage_const_1p2 )

			ig.plot(gg, layout = layout, target = ax)
			plt.show()

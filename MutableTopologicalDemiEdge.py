...
class MutableTopologicalDemiEdge(TopologicalDemiEdge):
    ...
    their specifity is that they have method to modify the map for instance you can delete them
    ...
    def deleteNode(self, trust=False):
        ...
        Args:
            trust: a parameter telling the method if it should trust the fact that the self.map will stay connected after
                deleteting self default is False 
        ----
    ...
    def copyOn(self, otherTopoDemiEdge):
        ...
        an error),this function will attache self before otherTopoDemiEdge and then copy otherTopoDemiEdge.map from this point on,

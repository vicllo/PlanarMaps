...
# This file was *autogenerated* from the file tests/PlanarMapTest.sage
...
def test_genus():
    ...
    assert LabelledMap(Permutation([(_sage_const_2 ,_sage_const_3 ,_sage_const_1 ,_sage_const_5 ),(_sage_const_4 ,),(_sage_const_6 ,)]),Permutation([(_sage_const_1 ,_sage_const_2 ),(_sage_const_3 ,_sage_const_4 ),(_sage_const_5 ,_sage_const_6 )])).genus() == _sage_const_0 

    # Test case 2: cube graph
    assert LabelledMap(adj = [(_sage_const_5 ,_sage_const_4 ,_sage_const_2 ),(_sage_const_1 ,_sage_const_3 ,_sage_const_6 ),(_sage_const_4 ,_sage_const_7 ,_sage_const_2 ),(_sage_const_8 ,_sage_const_3 ,_sage_const_1 ),(_sage_const_8 ,_sage_const_1 ,_sage_const_6 ),(_sage_const_5 ,_sage_const_2 ,_sage_const_7 ),(_sage_const_3 ,_sage_const_8 ,_sage_const_6 ),(_sage_const_7 ,_sage_const_4 ,_sage_const_5 )]).genus() == _sage_const_0 

    # Test case 2: complete bipartite graph with 2 * 3 nodes
    assert LabelledMap(adj = [(_sage_const_4 ,_sage_const_5 ,_sage_const_6 ),(_sage_const_4 ,_sage_const_5 ,_sage_const_6 ),(_sage_const_4 ,_sage_const_5 ,_sage_const_6 ),(_sage_const_1 ,_sage_const_2 ,_sage_const_3 ),(_sage_const_1 ,_sage_const_2 ,_sage_const_3 ),(_sage_const_1 ,_sage_const_2 ,_sage_const_3 )]).genus() == _sage_const_1 
...
def test_getRandomDyckPath():
    dyckPath = MapGenerator().getRandomDyckPath(_sage_const_50 )
    negative = False 
    level = _sage_const_0 

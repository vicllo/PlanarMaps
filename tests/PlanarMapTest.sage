...
def test_init_planar_map():
	...
	adj_2 = [(5,4,2),(1,3,6),(4,7,2),(8,3,1),(8,1,6),(5,2,7),(3,8,6),(7,4,5)]
...
def test_genus():
	...
	adj1 = [(5,4,2),(1,3,6),(4,7,2),(8,3,1),(8,1,6),(5,2,7),(3,8,6),(7,4,5)]
	assert PlanarMap(adj = adj1).genus() == 0

	# Test case 2
	# K_3_3 (genus 1)

	adj2 = [(4,5,6),(4,5,6),(4,5,6),(1,2,3),(1,2,3),(1,2,3)]
	assert PlanarMap(adj = adj2).genus() == 1
